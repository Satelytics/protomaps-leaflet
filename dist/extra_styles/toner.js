...
import { Font } from "../task";
import { arr, createPattern } from "../symbolizer";
import { CircleSymbolizer } from "../symbolizer";
import { GroupSymbolizer, CenteredTextSymbolizer, OffsetTextSymbolizer, } from "../symbolizer";
...
const Toner = (variant) => {
    ...
    let label_rules = [
        ...
        // },
        {
            ...
            filter: (z, f) => {
                return ["ocean", "sea"].includes(f.props.place);
            },
        },
        {
            dataLayer: "roads",
